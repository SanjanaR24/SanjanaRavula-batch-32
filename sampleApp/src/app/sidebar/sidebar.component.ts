...
//   isClicked=false;
//   items = [
//     { full_name: 'Sanjana Ravula', lead_name: 'Tejan', technology: 'Java' },
//     { full_name: 'Roshini Racha', lead_name: 'Manohar', technology: 'Java' },
//     { full_name: 'Rashmitha Reddy', lead_name: 'Kranthi', technology: 'Devops' },
//     { full_name: 'Sangamithra', lead_name: 'Tejan', technology: 'Devops' },
//     { full_name: 'Rishika', lead_name: 'Manohar', technology: 'Devops' },
//     { full_name: 'Bharathu', lead_name: 'Spandana', technology: 'Java' },
//     { full_name: 'Jahnavi', lead_name: 'Tejan', technology: 'Data Engineering' },
//     { full_name: 'Narain', lead_name: 'Tejan', technology: 'Data Engineering' },
//     { full_name: 'Uday', lead_name: 'Spandana', technology: 'Java' },
//     { full_name: 'Sri hari', lead_name: 'Kranthi', technology: 'Java' },
//   ];

//   technology=['Java','Devops','Data Engineering'];
//   lead_name=['Tejan','Manohar','Spandana','Kranthi'];
//   selectedTechnology='';
//   selectedLeadName='';
//   get filteredItems() {
//     return this.items.filter(item => {
//       const selectedTechnology = this.selectedTechnology ? item.technology === this.selectedTechnology : true;
//       const selectedLeadName = this.selectedLeadName ? item.lead_name === this.selectedLeadName : true;
//       return selectedTechnology && selectedLeadName;
//     });
//   }
//   constructor() { }
